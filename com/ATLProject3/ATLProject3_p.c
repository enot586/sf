...
extern const MIDL_STUBLESS_PROXY_INFO IObject_ProxyInfo;
...
/* Object interface: IObject, ver. 0.0,
   GUID={0x6fa0b230,0x8cfd,0x42aa,{0xb1,0xa7,0x1a,0xfd,0xeb,0x1a,0x43,0xaa}} */
...
static const MIDL_SERVER_INFO IObject_ServerInfo = 
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _IObjectProxyVtbl = 
{
    &IObject_ProxyInfo,
    &IID_IObject,
    ...
    (void *) (INT_PTR) -1 /* IObject::GetSharedMemoryName */
};
